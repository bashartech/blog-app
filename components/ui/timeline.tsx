...
export  const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div
      className="w-full bg-neutral-950 dark:bg-neutral-950 font-sans md:px-10"
      ref={containerRef}
    >
      

      <div ref={ref} className="relative max-w-7xl mx-auto pb-20 overflow-hidden md:overflow-visible ">
        {data.map((item, index) => (
          <div
            key={index}
